            ...
            <ul className="mt-2 text-sm leading-normal space-y-2">
              ...
              >
                ...
                <div>
                  ...
                  <div className="mt-6">
                    <a
                      href="mailto:hello@jabirmahmud.com"
                  ...
                  <div className="mt-8 grid gap-6 sm:grid-cols-2">
                    <div className={`p-5 rounded-lg ${themeObj.card}`}>
                      <h3
                        className={`text-lg font-medium mb-2 ${themeObj.text}`}
                      >
                        Let's connect
                      </h3>
                      <p className={`mb-4 ${themeObj.muted}`}>
                        Follow me on social media or check out my work on
                        GitHub.
                      </p>
                    ...
                    <div className={`p-5 rounded-lg ${themeObj.card}`}>
                      ...
                      <div className="space-y-3">
                        <p className={`flex items-center ${themeObj.muted}`}>
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="h-5 w-5 mr-2"
                            viewBox="0 0 20 20"
