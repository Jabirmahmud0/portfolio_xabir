  ...
  return (
    <div className="min-h-screen bg-[#f1f0ea] text-[#15201e] lg:grid lg:grid-cols-[280px_minmax(0,1fr)]">
      ...
      <div className="min-w-0">
        ...
        <nav className="fixed inset-x-3 bottom-3 z-50 grid grid-cols-4 rounded-2xl border border-white/20 bg-[#082e2a]/95 p-2 text-white shadow-2xl backdrop-blur-xl lg:hidden" aria-label="Administration">
